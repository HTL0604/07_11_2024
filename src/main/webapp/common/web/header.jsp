			...
			<div class="col-md-6 col-sm-6 additional-shop-info">
				<ul class="list-unstyled list-inline">
					...
					<li class="shop-currencies"><a href="javascript:void(0);"
						class="current">VND</a> <a href="javascript:void(0);">$</a></li>
					<!-- END CURRENCIES -->
					<!-- BEGIN LANGS -->
					<li class="langs-block"><a href="javascript:void(0);"
						class="current">Vietnamese </a>
			...
			<div class="col-md-6 col-sm-6 additional-nav">
				<ul class="list-unstyled list-inline pull-right">
					<c:choose>
						...
						<c:otherwise>
							<c:set var="currentRole" value="${sessionScope.roleString}" />
							<c:choose>
								<c:when test="${currentRole == 'VENDOR'}">
								
								
								<li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="javascript:void(0);">
											${sessionScope.account.firstname} ${sessionScope.account.lastname} <span class="caret"></span>
									</a>
									<ul class="dropdown-menu">
											<li><a href="${pageContext.request.contextPath}/vendor/myaccount " >My Account</a></li>
											<li><a href="${pageContext.request.contextPath}/logout">Logout</a></li>
										</ul></li>
									<li><a href="${pageContext.request.contextPath }/vendor/stores">Store Manager</a></li>
									 <!-- BEGIN DROPDOWN MENU -->
								...
								<c:otherwise>
								<li><a
										href="${pageContext.request.contextPath }/user/mycart">My Cart</a></li>
									...
									<!-- BEGIN DROPDOWN MENU -->
										<ul class="dropdown-menu">
											<li class="dropdown-submenu"><a
												href="${pageContext.request.contextPath }/user/myaccount">My Account </a>
											</li>
...
<div class="header">
	<div class="container">
		<a class="site-logo" href="${pageContext.request.contextPath }/home"><img
			src="${pageContext.request.contextPath }/assets/frontend/layout/img/logos/ute_shop_logo.png"
		...
		<div class="top-cart-block">
			<div class="top-cart-info">
				<a href="javascript:void(0);" class="top-cart-info-count">0 item</a>
...
<script>
function confirmSignOut() { // Show confirmation dialog 
	var userConfirmed = confirm("Are you sure you want to sign out?"); // If the user confirms, redirect to the logout URL 
if (userConfirmed) { // Redirect to your LogoutController 
...
<script src="/../../assets/frontend/layout/js/scripts/layout.js"></script>
<script src="/../../assets/frontend/layout/js/scripts/back-to-top.js"></script>